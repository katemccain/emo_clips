...
run1_pls = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_1/cal_pilot_1_22_24_A_20240122_035813.fl35h0.E1.app1';
run1_neut = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_1/cal_pilot_1_22_24_A_20240122_035813.fl35h0.E1.app2';
run1_unpls = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_1/cal_pilot_1_22_24_A_20240122_035813.fl35h0.E1.app3';

run2_pls = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_2/cal_pilot_1_22_24_second_run_20240122_042744.fl35h0.E1.app1';
run2_neut = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_2/cal_pilot_1_22_24_second_run_20240122_042744.fl35h0.E1.app2';
run2_unpls = '/home/andrewf/Research_data/EEG/video_alpha_UF/cal_pilot/EEG/run_2/cal_pilot_1_22_24_second_run_20240122_042744.fl35h0.E1.app3';
...
%Pz
figure(1)
contourf(time_axis, frequency_axis(2:end), squeeze(wapower_run1_pls(126,:,2:end))'), colorbar
caxis([.8 4])
figure(2)
contourf(time_axis, frequency_axis(2:end), squeeze(wapower_run1_neut(126,:,2:end))'), colorbar
caxis([.8 4])
figure(3)
contourf(time_axis, frequency_axis(2:end), squeeze(wapower_run1_unpls(126,:,2:end))'), colorbar
caxis([.8 4])
figure(11)
contourf(time_axis, frequency_axis(2:end), squeeze(outWaMat_run1_pls(126,:,2:end))'), colorbar
caxis([-70 35])
figure(12)
contourf(time_axis, frequency_axis(2:end), squeeze(outWaMat_run1_neut(126,:,2:end))'), colorbar
caxis([-70 35])
figure(13)
contourf(time_axis, frequency_axis(2:end), squeeze(outWaMat_run1_unpls(126,:,2:end))'), colorbar
caxis([-70 35])
